...
- [x] Downloadable mapped data
- [x] Exploratory composite-index laboratory
- [x] Methodology and source documentation
- [x] Automated tests and CI

## Phase 2 — Census business structure

- [ ] County Business Patterns integration
- [ ] State business-density indicators
- [ ] County establishment and employment indicators
- [ ] Industry concentration measures
- [ ] Census API key configuration and caching
- [ ] County FIPS normalization

## Phase 3 — Capital infrastructure

- [ ] CDFI Fund public-data integration
- [ ] Community-development finance coverage measures
- [ ] Small-business lending/program geography where authoritative public data permit
